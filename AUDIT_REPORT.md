...
```astro
<!-- Current (problematic) -->
<p class="text-xs text-subtle uppercase">Metric Label</p>

<!-- Should be -->
<p class="text-xs text-body font-medium uppercase tracking-wide">Metric Label</p>
```
...
```astro
<!-- Metric Label -->
<p class="text-sm font-semibold text-body uppercase tracking-wide">
  {metric.label}
</p>
...
<span class="inline-flex items-center px-2 py-1 text-sm font-semibold bg-primary-50 text-primary rounded-full">
  {smallMetric}
</span>
```
