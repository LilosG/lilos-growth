...
export const resultsStats: ResultsStat[] = [
  ...
  { id: 'gbp-calls', label: 'GBP calls vs. baseline', value: '3.2×', note: 'After profile fixes & posting cadence' },
  { id: 'cpl', label: 'Cost per lead (blended)', value: '−38%', note: 'Landing page + tracking improvements' },
  { id: 'vitals', label: 'Core Web Vitals pass rate', value: '96%', note: 'Post-migration to Astro' },
];

/** Logo wall */
export const resultsLogos: LogoItem[] = [
  { name: 'Blue Door Pest Control', href: '/work/blue-door', src: '/clients/blue-door-pest-control.jpg' },
  { name: 'Tamarack Restoration', href: '/work/tamarack', src: '/clients/tamarack-restoration.webp' },
  { name: 'Carlsbad Home Services', href: '/work/carlsbad-home-services', src: '/clients/carlsbad-home-services.png' },
  { name: 'Postal Systems' },
...
export const resultsFaqs: FaqItem[] = [
  ...
  { q: 'How is success measured?', a: 'Leads and booked jobs; we also track GBP actions, CVR, speed, and rankings.' },
  {
