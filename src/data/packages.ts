export const clientStats = [
  { stat: '613%', label: 'Keyword growth', sub: 'Wheyland Electric — 16 to 114 keywords in 90 days' },
  { stat: '3,400%', label: 'Keyword growth', sub: 'Restoration client — 12 to 420 keywords in 12 months' },
  { stat: '22', label: 'Top 3 Google rankings', sub: 'Wheyland Electric — from 1 at launch to 22 in 90 days' },
];
...
export const caseStudies = [
  {
    ...
    summary: 'Full site build on Astro + Tailwind, local SEO retainer, GBP management. Started from near zero.',
    timeframe: '90 days',
  ...
  },
  {
    ...
    summary: 'New Astro/Tailwind site build with full local SEO — launched into a competitive market with zero prior rankings.',
    timeframe: '60 days',
...
export const gbpOneTime = {
  ...
  description: 'A one-time deep optimization of your Google Business Profile — every field, every category, every signal. Built to rank and convert from day one.',
  inclusions: [
...
export const websiteBuilds = [
  ...
  },
  {
    ...
    pages: '10–15 pages',
    timeline: '3–4 weeks',
    description: 'Full local SEO site with service pages, city pages, and service × city page architecture.',
  ...
  },
  {
    ...
    pages: '25–40+ pages',
    timeline: '4–6 weeks',
    description: 'A complete local search authority site built to dominate every service and city in your market.',
...
export const audits = [
  {
    ...
    description: "A scored, benchmarked review of your Google Business Profile against the top 3 competitors in your local pack. You'll see exactly what's missing, what's hurting you, and what to fix first.",
    inclusions: [
  ...
  },
  {
    ...
    price: 499,
    delivery: '5–7 business days',
    description: 'A comprehensive audit of your entire local search presence — GBP, technical SEO, keyword landscape, competitive position, schema, citations, and AI visibility. Delivered as a structured PDF with a 90-day action plan.',
    inclusions: [
