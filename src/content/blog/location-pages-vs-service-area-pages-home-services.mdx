...
faqs:
  - question: "How many city landing pages is too many?"
    answer: "If you cannot add real, unique proof to a page — local job examples, area-specific reviews, or genuinely different service details — then it is too many. Thin city pages with duplicated content can hurt your overall site quality signals."
  - question: "Will city landing pages help my Google Maps rankings?"
    answer: "Indirectly, yes. City pages build relevance and local topical authority that reinforces your GBP signals. They also convert organic search traffic from city-specific queries that map pack results do not capture."
  - question: "What should I do if my city page is not getting indexed by Google?"
    answer: "Check for thin or duplicate content first — add unique local proof, job examples, and area-specific details. Make sure the page is linked from your main service hub and from your footer or a city index page. Submit the URL in Google Search Console for a manual indexing request." 
---
