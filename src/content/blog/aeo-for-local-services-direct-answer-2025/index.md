...
1. **Entities** – service types, sub-services, cities/ZIPs, tools/methods, outcomes.
2. **Questions** – timing, cost, safety, prep, outcomes, edge cases.
3. **Answer Pages** – one intent per page; answer at the top; proof below.
4. **Evidence** – job photos with captions, meter readings, review snippets naming entities.
5. **Distribution** – GBP Posts, social, email; point to the Answer Page with UTM.
...
- **Services & sub-services:** water damage restoration, emergency extraction; ant control, _German cockroach treatment_; sliding door replacement.
...
- UTM-tag every button: `utm_source=google&utm_medium=gbp-post&utm_campaign=yyyy-mm-[service]-[city]`.
...
### Water Damage — _How long to dry a ceiling leak in Encinitas?_
...
### Pest Control — _How fast does pet-safe German roach treatment work in Jupiter?_
...
### Handyman — _Do I need a permit for sliding door replacement in Carlsbad?_
