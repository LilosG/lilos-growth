...
draft: false
image: '/images/blog/gbp-post-formats-that-drive-calls-2025/hero.svg'
imageAlt: 'Seven GBP post cards fanning into a monthly calendar'
---
...
| utm_source   | google                                                             |
| utm_medium   | gbp-post                                                           |
| utm_campaign | yyyy-mm-[service]-[format] _(e.g., 2025-10-ants-offer)_            |
| utm_content  | [city-or-neighborhood]                                             |
| Landing URL  | Point to the **most relevant page** (service + city, not homepage) |

**Examples**

- `/ant-control-jupiter/?utm_source=google&utm_medium=gbp-post&utm_campaign=2025-10-ants-offer&utm_content=abacoa`
- `/emergency-water-extraction-encinitas/?utm_source=google&utm_medium=gbp-post&utm_campaign=2025-10-extraction-urgent-tip&utm_content=leucadia`

---

## Image Production SOP (Fast + On-Brand)

1. Create a **7-template** set (one per format) with brand colors and fonts.
2. Maintain a **local photo library** tagged by city/neighborhood.
3. For Before/After: keep a meter-reading overlay style (`68% → 12% RH in 48h`).
4. Keep text minimal: **headline ≤ 7 words** on image.
5. Export **1200×900** (or your theme’s documented ratio), <200 KB when possible.
