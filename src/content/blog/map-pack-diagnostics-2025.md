...
1. **Proximity** problems block you entirely (you won’t appear).
2. **Relevance** mismatches cap your impressions and justifications.
3. **Prominence** decides who wins among relevant, nearby options.
...
- Add/repair **service areas** and **/service-areas/<city>/** pages.
- Ensure **SAB** vs storefront is compliant; hide address if SAB.
