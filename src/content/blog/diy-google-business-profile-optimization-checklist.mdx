...
faqs:
  - question: "How fast will I see results from optimizing my Google Business Profile?"
    answer: "In less competitive markets, you may see ranking improvements within days to a couple of weeks. In competitive markets with established players, expect a longer ramp — typically two to four months — as you build reviews, content, and local links alongside profile improvements."
  - question: "Do Google Business Profile posts help with rankings?"
    answer: "Yes, as part of a healthy overall strategy. Posts signal relevance and activity to Google, and they can appear directly in search results. They work best paired with consistent review velocity and strong website content — posts alone will not compensate for weak fundamentals."
  - question: "Should I add keywords to my Google Business Profile name?"
    answer: "No. Use your real-world business name exactly as it appears on your signage and registration. Adding keywords to your business name is a guideline violation and can result in profile suspension or a name edit request."
  - question: "What should I do if my home service business serves multiple cities?"
    answer: "Set up your profile as a service-area business, list the cities and ZIP codes you actually serve, and build dedicated city landing pages on your website for each market you want to rank in. Avoid listing a fake address in each city — this violates Google's guidelines." 
---
